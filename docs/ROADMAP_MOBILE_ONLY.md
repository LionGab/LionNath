...
<Button
  onPress={() => supabase.functions.invoke("postpartum-screening")}
  title="Fazer Triagem de Saúde Mental"
/>
...
{screening && (
  <Card>
    ...
    {screening.riskScore > 13 && (
      <Alert color="red">
        ⚠️ Você pode estar com risco de depressão pós-parto.
...
*Documento: ROADMAP_MOBILE_ONLY.md*
